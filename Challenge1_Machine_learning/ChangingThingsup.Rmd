...
calc_error <- function(kNear, train_tbl, test_tbl) {
  ...
  knn_model <- knn3(Number ~ Size_Light + Light, data=train_tbl, k=kNear)
...
```{r}
NumberRecipe <- 
  recipe(Number ~ Size_Light + Light, data=train_tbl)
